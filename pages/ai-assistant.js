  ...
  return (
    <div id="mainApp">
      <Head>
        ...
        <meta name="description" content="Get instant explanations, summaries, and study help" />
      </Head>
      ...
      <nav className="top-nav">
        ...
        <div className="nav-links">
          ...
          <Link href="/ai-assistant" className="nav-link active">
      ...
      <main className="main-content">
        <div className="content-section active">
          ...
          <p className="section-desc">Get instant explanations, summaries, and study help</p>
          
          <div className="ai-container">
            <div className="ai-features">
              <button className="ai-feature-btn active">
              ...
              <div id="aiChat" className="ai-chat">
                <div className="ai-message bot">
                  ...
                  <div className="message-content">
                    <p>Hi! I'm your AI study assistant. Ask me anything about your course topics, and I'll help you understand them better! 📚</p>
                  </div>
                </div>
                <div className="ai-message user">
                  <i className="fas fa-user"></i>
                  <div className="message-content">
                    <p>Can you explain what a variable is in programming?</p>
                  </div>
                </div>
                <div className="ai-message bot">
                  <i className="fas fa-robot"></i>
                  <div className="message-content">
                    <p>Sure! In programming, a variable is a named storage location that holds a value which can be changed during program execution. Think of it like a labeled box where you can store different items (values) and retrieve them later by using the label (variable name).</p>
                    <p>For example, in Python:</p>
                    <pre><code>age = 25
name = "John"
is_student = True</code></pre>
                    <p>Here, age, name, and is_student are variables storing different types of data.</p>
                  </div>
                </div>
              </div>
      ...
      <nav className="bottom-nav">
        ...
        <Link href="/ai-assistant" className="bottom-nav-link active">
          <i className="fas fa-robot"></i>
          <span>AI Assistant</span>
        </Link>
