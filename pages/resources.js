...
export default function Resources() {
  return (
    <div id="mainApp">
      <Head>
        <title>Learnify - Learning Resources</title>
        <meta name="description" content="Curated notes, tutorials, and study materials from trusted sources" />
      </Head>
      ...
      <nav className="top-nav">
        ...
        <div className="nav-links">
          ...
          <Link href="/resources" className="nav-link active">
      ...
      <main className="main-content">
        <div className="content-section active">
          ...
          <p className="section-desc">Curated notes, tutorials, and study materials from trusted sources</p>
          
          <div className="resource-filters">
            <input type="text" id="resourceSearch" placeholder="Search resources..." />
            <select id="resourceCourseFilter">
            ...
            <select id="resourceSemesterFilter">
            ...
            <select id="resourceFilter">
              ...
              <option value="notes">Notes & Tutorials</option>
            </select>
          </div>
          ...
          <div id="resourcesGrid" className="resources-grid">
            ...
            <div className="resource-card">
              <div className="resource-header">
                ...
                <div className="resource-badge">PDF</div>
              </div>
              <h3>Mathematics Formula Sheet</h3>
              <p>Comprehensive formula sheet for all mathematics topics covered in BCA semester 1</p>
              <div className="resource-meta">
                <span><i className="fas fa-calendar"></i> Updated: 15 Oct 2025</span>
                <span><i className="fas fa-download"></i> 1.2K downloads</span>
              </div>
              <a href="#" className="resource-link-btn">
            ...
            <div className="resource-card">
              ...
              <p>Complete video tutorial series covering C programming basics</p>
              <div className="resource-meta">
                <span><i className="fas fa-calendar"></i> Updated: 10 Oct 2025</span>
                <span><i className="fas fa-clock"></i> 2h 30m</span>
              </div>
              <a href="#" className="resource-link-btn">
      ...
      <nav className="bottom-nav">
        ...
        <Link href="/resources" className="bottom-nav-link active">
          <i className="fas fa-book"></i>
          <span>Resources</span>
        </Link>
