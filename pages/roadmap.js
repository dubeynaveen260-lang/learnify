...
export default function Roadmap() {
  return (
    <div id="mainApp">
      <Head>
        <title>Learnify - Course Roadmap</title>
        <meta name="description" content="Track your learning journey through structured courses" />
      </Head>
      ...
      <nav className="top-nav">
        ...
        <div className="nav-links">
          ...
          <Link href="/roadmap" className="nav-link active">
      ...
      <main className="main-content">
        <div className="content-section active">
          ...
          <p className="section-desc">Track your learning journey through structured courses</p>
          ...
          <div className="info-note">
            ...
            <span>Note: Some YouTube videos may occasionally be unavailable. If you encounter this, please try another link from the same topic or check back later.</span>
          </div>

          <div id="roadmapContainer" className="roadmap-container">
            {/* Roadmap will be dynamically loaded here */}
            <div className="subject-card">
              <div className="subject-header">
                <h3><i className="fas fa-book"></i> Mathematics</h3>
                <div className="subject-progress">0/10 topics completed</div>
              </div>
              <div className="topics-list">
                <div className="topic-item">
                  <div className="topic-header">
                    <div className="topic-name">Algebra Basics</div>
                    <div className="topic-status">
                      <button className="btn-complete">Mark Complete</button>
                      <button className="topic-menu-btn">
                  ...
                  <div className="topic-resources">
                    <a href="#" className="resource-link">
                      <i className="fas fa-video"></i> Watch Video Tutorial
                    </a>
                    <a href="#" className="resource-link">
                      <i className="fas fa-file-pdf"></i> Download Notes
                    </a>
                  </div>
                </div>
              </div>
      ...
      <nav className="bottom-nav">
        ...
        <Link href="/roadmap" className="bottom-nav-link active">
          <i className="fas fa-map"></i>
          <span>Roadmap</span>
        </Link>
